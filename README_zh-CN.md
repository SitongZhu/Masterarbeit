...
默认分支 **`main`** 已合并 `fix/code-review-20260915` 中经 2026-09-15
复核的五项代码修复及回归测试（审查提交
[`e3d796f`](https://github.com/SitongZhu/Masterarbeit/commit/e3d796fca54ceac3caebc0f49e5e08724612207f)）。
普通克隆即可获得修复后的维护版本：
...
已有克隆可依次运行 `git fetch origin`、`git switch main` 和
`git pull --ff-only origin main`。

对应的[修复说明](docs/CODE_REVIEW_FIXES_20260915.md)和
[包含源码哈希的验证记录](docs/validation/code_review_20260915.json)均随代码提供。

历史 tag **`results-2026-09-14`** 和 **`results-2026-09-15`** 均保留在原提交，
用于复现固定的论文快照，**不包含归档后的这五项代码修复**。
复现 2026-09-15 论文归档时，请显式指定 tag：
