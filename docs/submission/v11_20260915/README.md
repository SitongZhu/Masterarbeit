...
The subsequent [appendix-reference revision](../v11_appendix_refs_20260915/README.md) records the current editorial PDF. The frozen PDF identifiers below remain valid.
